...
using FUNFOX.NET5.Client.Infrastructure.Authentication;
using FUNFOX.NET5.Client.Infrastructure.Managers;
using FUNFOX.NET5.Client.Infrastructure.Managers.ExtendedAttribute;
using FUNFOX.NET5.Client.Infrastructure.Managers.Preferences;
...
namespace FUNFOX.NET5.Client.Extensions
{

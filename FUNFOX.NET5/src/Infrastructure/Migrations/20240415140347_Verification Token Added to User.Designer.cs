...
namespace FUNFOX.NET5.Infrastructure.Migrations
{
    ...
    [Migration("20240415140347_Verification Token Added to User")]
    partial class VerificationTokenAddedtoUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FUNFOX.NET5.Application.Models.Chat.ChatHistory<FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroUser>", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FUNFOX.NET5.Domain.Entities.Catalog.Class", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FUNFOX.NET5.Infrastructure.Models.UserClassEnrollment", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("UserClassEnrollments");
                });
            ...
            modelBuilder.Entity("FUNFOX.NET5.Application.Models.Chat.ChatHistory<FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroUser>", b =>
                {
                    b.HasOne("FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroUser", "FromUser")
                        .WithMany("ChatHistoryFromUsers")
                        .HasForeignKey("FromUserId");

                    b.HasOne("FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroUser", "ToUser")
            ...
            modelBuilder.Entity("FUNFOX.NET5.Domain.Entities.Catalog.Class", b =>
                {
                    b.HasOne("FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroUser", null)
                        .WithMany("EnrolledClasses")
                        .HasForeignKey("BlazorHeroUserId");

                    b.OwnsOne("FUNFOX.NET5.Domain.Entities.Catalog.Timings", "Timing", b1 =>
                        {
            ...
            modelBuilder.Entity("FUNFOX.NET5.Infrastructure.Models.UserClassEnrollment", b =>
                {
                    b.HasOne("FUNFOX.NET5.Domain.Entities.Catalog.Class", "Class")
                        .WithMany()
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroUser", "BlazorHeroUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BlazorHeroUser");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    b.HasOne("FUNFOX.NET5.Infrastructure.Models.Identity.BlazorHeroRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

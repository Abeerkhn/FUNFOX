...
using FUNFOX.NET5.Infrastructure.Helpers;
...
using FUNFOX.NET5.Shared.Constants.User;
...
using static FUNFOX.NET5.Shared.Constants.Permission.Permissions;

namespace FUNFOX.NET5.Infrastructure
{
        ...
        private void AddBasicUser()
        {
            Task.Run(async () =>
            {
                ...
                if (basicUserInDb == null)
                {
                    ...
                    // Assign specific permissions to the basic user role
                    await _roleManager.AddPermissionClaim(basicRole,  Classes.View  ); ;
                    await _roleManager.AddPermissionClaim(basicRole, BasicUserPermissions.EnrollInClasses);
                    await _roleManager.AddPermissionClaim(basicRole,Communication.Chat);
                    // Add more permissions as needed for basic users

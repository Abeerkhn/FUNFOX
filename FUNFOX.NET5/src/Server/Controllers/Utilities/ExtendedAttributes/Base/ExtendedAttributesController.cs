...
using FUNFOX.NET5.Application.Features.ExtendedAttributes.Commands.Delete;
...
using FUNFOX.NET5.Application.Features.ExtendedAttributes.Queries.GetById;
using FUNFOX.NET5.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;
using System;
using System.Threading.Tasks;

namespace FUNFOX.NET5.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>

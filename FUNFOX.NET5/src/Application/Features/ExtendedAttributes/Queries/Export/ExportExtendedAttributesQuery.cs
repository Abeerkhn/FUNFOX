...
using FUNFOX.NET5.Application.Specifications.ExtendedAttribute;
using FUNFOX.NET5.Domain.Contracts;
using FUNFOX.NET5.Domain.Enums;
...
namespace FUNFOX.NET5.Application.Features.ExtendedAttributes.Queries.Export
{
